                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="about.blade.php">About</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="catalog.blade.php">Products</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover active" href="rent.blade.php">FAQ</a></li>
