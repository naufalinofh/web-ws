        ...
        <div class="content-lg container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-1">
                    <img class="img-responsive" src="{{ url('customer_assets/img/640x380/01.jpg') }}" alt="Our Office">
                </div>
            </div>
            <!--// end row -->
        </div>
            ...
            <div class="content-lg container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="bg-color-white margin-b-20">
                            <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                                <img class="img-responsive" src="{{ asset('customer_assets/img/770x860/01.jpg') }}" alt="Team Image">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="bg-color-white margin-b-20">
                            <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                                <img class="img-responsive" src="{{ asset('customer_assets/img/770x860/02.jpg') }}" alt="Team Image">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="bg-color-white margin-b-20">
                            <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                                <img class="img-responsive" src="{{ asset('customer_assets/img/770x860/03.jpg') }}" alt="Team Image">
                            </div>
                        </div>
